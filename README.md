...
<img width="376" height="536" alt="image" src="https://github.com/user-attachments/assets/0defc9ad-e7a9-4214-a4a2-a0fbadb40a2f" />
...
- so i thought it wold be cooll to make my own, where all these sensors are merged into one, and actually tell me to do something if certain levels are too high!!
